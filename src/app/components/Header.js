...
export default function Header() {
  return (
    <div className="flex flex-wrap items-center"> 
      ...
      <h4 className="relative ml-40 text-black text-1xl">Contact Us</h4>
      <button className="relative ml-10 h-8 w-45 px-4 rounded-sm border border-black text-black border-black">SIGN UP</button>
      <button className="relative ml-10 h-8 w-45 px-4 rounded-sm border border-black text-black border-black">SIGN IN</button>
